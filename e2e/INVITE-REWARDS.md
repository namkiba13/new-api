...
- User history has inviter, invitee and pooled reward-transfer views. The server derives identity from authentication; recipient journals and actual credits for other accounts are excluded. The new `received` summary reports the invitee's pending amount and recorded wallet credits.

...
try {
  ...
  assert.equal(await hap.getByRole('button',{name:'No transferable rewards',exact:true}).isDisabled(),true,'Pending-only rewards cannot be transferred')
  ...
  assert.equal(await hbp.getByRole('button',{name:'No transferable rewards',exact:true}).isDisabled(),true,'Welcome reward is already in Credits')
  ...
  await hbp.getByRole('button',{name:'Transfer all rewards',exact:true}).click()

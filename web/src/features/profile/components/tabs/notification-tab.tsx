  ...
  return (
    <div className='space-y-6'>
          ...
          {NOTIFICATION_METHODS.map((method) => {
            ...
            return (
              <ToggleGroupItem
                key={method.value}
                value={method.value}
                className='data-pressed:border-primary data-pressed:bg-primary/5 h-11 w-full justify-start gap-2 rounded-lg px-3 text-sm'
              >
      ...
      <div className='overflow-hidden rounded-lg border'>
        ...
        {isAdmin && (
          <div className='flex items-start justify-between gap-4 border-b px-4 py-4 last:border-b-0 sm:items-center'>

  ...
  useEffect(() => {
    ...
    const loadContent = async () => {
      ...
      try {
        ...
        // The branded home page remains fully usable without optional custom
        // content. Keep cached content (when available) and avoid interrupting
        // visitors with duplicate network-error notifications.
      } finally {
        if (mounted) {
          setIsLoaded(true)
        }

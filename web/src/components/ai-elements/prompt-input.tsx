...
> & {
  ...
  onError?: (err: {
    code: 'max_files' | 'max_file_size' | 'accept' | 'read_file'
    message: string
  }) => void
  onSubmit: (
...
export const PromptInput = ({
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = (event) => {
    ...
    Promise.all(
      ...
      .catch(() => {
        // Keep attachments when conversion fails so they can be retried.
        onError?.({ code: 'read_file', message: t('Failed to read file') })
      })
  }
  ...
  useEffect(() => {
    if (
      ...
      speechRecognition.onresult = (event) => {
        ...
        // SpeechRecognitionResultList is array-like, not iterable in all browsers.
